## Functions for transforming bodies of text into lists of relevant
## uni-, bi-, and trigrams
...
def create_trigrams_file(original_file, new_file, words_to_compare,
	method="keep", delimiter='\t', word_sep='|', has_ids=True,
	trigram_word_sep='|', encoding='utf-8'):
	...
	transcript_generator = core.RawCorpus(
		original_file, delimiter, word_sep, encoding=encoding,
		has_header=False)
